...
#ifndef _SMARTCHIP_GPIO_H
#define _SMARTCHIP_GPIO_H
...
void smartx_gpio_set_value(unsigned int group, unsigned int port, unsigned int gpio, unsigned int val);
unsigned int smartx_gpio_get_value(unsigned int group, unsigned int port, unsigned int gpio);
void smartx_gpio_set_direction(unsigned int group, unsigned int port, unsigned int gpio, unsigned int direction);
unsigned int smartx_gpio_get_direction(unsigned int group, unsigned int port, unsigned int gpio);
int smartx_pinshare_from_env(void);
#endif /* _SMARTCHIP_GPIO_H */
