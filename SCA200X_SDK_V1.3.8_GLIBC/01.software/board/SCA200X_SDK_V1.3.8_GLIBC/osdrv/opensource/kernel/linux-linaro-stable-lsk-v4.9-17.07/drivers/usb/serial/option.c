...
#define YUGA_AC3_VENDOR_ID			0x1286
...
/* Add for YUGA AC3 */
static const struct option_blacklist_info YUGA_AC3_blacklist = {
	/* interface 0,1: Network Adapter
	 * interface 2  : Diag
	 * interface 3  : AT
	 * interface 4  : Modem
	 */
...
static const struct usb_device_id option_ids[] = {
	...
	/* Add for YUGA AC3 */
	{ USB_DEVICE(YUGA_AC3_VENDOR_ID, YUGA_PRODUCT_AC3),
		.driver_info = (kernel_ulong_t)&YUGA_AC3_blacklist },
