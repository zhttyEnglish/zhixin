...
static int da9062_regulator_set_voltage_sel_regmap(struct regulator_dev *rdev, unsigned sel)
{
	/*
		LDO From 0.9V(0x02) to 3.6V(0x38) Less than 0x02 greater than 0x38
		set voltage must add offset 0x02.
	*/

	return regulator_set_voltage_sel_regmap(rdev, sel+0x2);
...
static const struct regulator_ops da9062_ldo_ops = {
	...
	.is_enabled		= regulator_is_enabled_regmap,
	.get_voltage_sel	= regulator_get_voltage_sel_regmap,
	.set_voltage_sel	= da9062_regulator_set_voltage_sel_regmap,
	.list_voltage		= regulator_list_voltage_linear,
