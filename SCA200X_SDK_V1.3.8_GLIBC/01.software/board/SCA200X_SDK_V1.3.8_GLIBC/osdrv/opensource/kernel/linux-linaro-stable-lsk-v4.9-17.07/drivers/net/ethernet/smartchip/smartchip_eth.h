...
#define SMARTX_ETH_PWR_CTRL   0x1000
#define SMARTX_ETH_RST_CTRL   0x1004
#define SMARTX_ETH_TX_BRIDGE  0x100C
#define SMARTX_ETH_RX_BRIDGE  0x1010
#define SMARTX_ETH_RMII_CTRL  0x101c

#define SMARTX_ETH_RMII_SEL   0x40 //bit 6 is rmii/rgmii selection
