...
irqreturn_t xhci_irq(struct usb_hcd *hcd)
{
	...
	//printk(KERN_ERR"xhci irq 11111111 \n");

	spin_lock(&xhci->lock);
	/* Check if the xHC generated the interrupt, or the irq is shared */
	status = readl(&xhci->op_regs->status);
	//printk(KERN_ERR"xhci irq 222222222: %08x \n", status);

	if (status == 0xffffffff)
		goto hw_died;
	//printk(KERN_ERR"xhci irq 222222222 \n");
...
hw_died:
	...
	//printk(KERN_ERR"xhci irq 333333333 \n");
	...
	//printk(KERN_ERR"xhci irq 44444444 \n");

	if (hcd->irq) {
		//printk(KERN_ERR"xhci irq 5555555 irq : %08x\n", hcd->irq);
		u32 irq_pending;
	...
	//printk(KERN_ERR"xhci irq 5555555 \n");
	...
	//printk(KERN_ERR"xhci irq 666666666 \n");
	...
	//printk(KERN_ERR"xhci irq 777777 \n");
	...
	//printk(KERN_ERR"xhci irq 888888888 \n");

	/* Clear the event handler busy flag (RW1C); event ring is empty. */
	temp_64 |= ERST_EHB;
	xhci_write_64(xhci, temp_64, &xhci->ir_set->erst_dequeue);
	//printk(KERN_ERR"xhci irq 99999999 \n");
