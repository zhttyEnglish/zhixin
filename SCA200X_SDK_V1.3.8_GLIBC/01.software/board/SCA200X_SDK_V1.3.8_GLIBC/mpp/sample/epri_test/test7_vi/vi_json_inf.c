...
cJSON *struct_to_json_Ng_vi_test(void* struct_obj)
{
	...
	Ng_vi_test *struct_obj_ = (Ng_vi_test *)struct_obj;
    ...
    s2j_json_set_basic_element(json_obj_, struct_obj_, string, output_url);
...
{
	s2j_create_struct_obj(struct_obj_, Ng_vi_test);
    ...
    s2j_struct_get_basic_element(struct_obj_,json_obj, string, output_url);
