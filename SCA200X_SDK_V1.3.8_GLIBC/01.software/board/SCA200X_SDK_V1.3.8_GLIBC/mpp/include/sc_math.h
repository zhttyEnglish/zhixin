...
** SPAN(SC_U32, 100, 200) is 200 - 100 = 100
** SPAN(SC_U32, 200, 100) is 0xFFFFFFFF - 200 + 100
** SPAN(SC_U64, 200, 100) is 0xFFFFFFFFFFFFFFFF - 200 + 100
******************************************************************************/
...
__inline static SC_BOOL IS_LITTLE_END(void)
{
    union unEND_TEST_U
    {
        SC_CHAR cTest[4];
    ...
    return (unEndTest.u32Test > 0x01020304) ? (SC_TRUE) : (SC_FALSE);
}
...
******************************************************************************/
__inline static SC_VOID Rgb2Yc(SC_U16 r, SC_U16 g, SC_U16 b, SC_U16 *py, SC_U16 *pcb, SC_U16 *pcr)
{
    /* Y */
    *py = (SC_U16)((((r * 66 + g * 129 + b * 25) >> 8) + 16) << 2);

    /* Cb */
    *pcb = (SC_U16)(((((b * 112 - r * 38) - g * 74) >> 8) + 128) << 2);

    /* Cr */
    *pcr = (SC_U16)(((((r * 112 - g * 94) - b * 18) >> 8) + 128) << 2);
}

__inline static SC_U32 Rgb2Yuv(SC_U32 u32Rgb)
{
    SC_U16 y, u, v;
...
__inline static SC_VOID Rgb2Yc_full(SC_U16 r, SC_U16 g, SC_U16 b, SC_U16 *py, SC_U16 *pcb, SC_U16 *pcr)
{
    SC_U16 py_temp, pcb_temp, pcr_temp;

    py_temp = (SC_U16)(((r * 76 + g * 150 + b * 29) >> 8) * 4);
    pcb_temp = (SC_U16)(CLIP_MIN(((((b * 130 - r * 44) - g * 86) >> 8) + 128), 0) * 4);
    pcr_temp = (SC_U16)(CLIP_MIN(((((r * 130 - g * 109) - b * 21) >> 8) + 128), 0) * 4);
...
__inline static SC_U32 Rgb2Yuv_full(SC_U32 u32Rgb)
{
    SC_U16 y, u, v;
...
******************************************************************************/
__inline static SC_VOID Rgb2Yc_8BIT(SC_U8 r, SC_U8 g, SC_U8 b, SC_U8 *py, SC_U8 *pcb, SC_U8 *pcr)
{
    /* Y */
    *py = (SC_U8)(((r * 66 + g * 129 + b * 25) >> 8) + 16);

    /* Cb */
    *pcb = (SC_U8)((((b * 112 - r * 38) - g * 74) >> 8) + 128);

    /* Cr */
    *pcr = (SC_U8)((((r * 112 - g * 94) - b * 18) >> 8) + 128);
}

__inline static SC_U32 Rgb2Yuv_8BIT(SC_U32 u32Rgb)
{
    SC_U8 y, u, v;
...
__inline static SC_VOID Rgb2Yc_full_8BIT(SC_U8 r, SC_U8 g, SC_U8 b, SC_U8 *py, SC_U8 *pcb, SC_U8 *pcr)
{
    SC_S16 py_temp, pcb_temp, pcr_temp;
...
__inline static SC_U32 Rgb2Yuv_full_8BIT(SC_U32 u32Rgb)
{
    SC_U8 y, u, v;
...
**
*******************************************************************************/
typedef struct scFPS_CTRL_S
{
    SC_U32 u32Ffps; /* Full frame rate    */
    SC_U32 u32Tfps; /* Target frame rate  */
    SC_U32 u32FrmKey; /* update key frame   */
} FPS_CTRL_S;

__inline static SC_VOID InitFps(FPS_CTRL_S *pFrmCtrl, SC_U32 u32FullFps,
    SC_U32 u32TagFps)
{
...
__inline static SC_BOOL FpsControl(FPS_CTRL_S *pFrmCtrl)
{
    SC_BOOL bReturn = SC_FALSE;
...
__inline static SC_U32 GetLowAddr(SC_U64 u64Phyaddr)
{
    return (SC_U32)u64Phyaddr;
}

__inline static SC_U32 GetHighAddr(SC_U64 u64Phyaddr)
{
    return (SC_U32)(u64Phyaddr >> 32);
}

#define sc_usleep(usec) \
    do { \
        usleep(usec); \
    } while (0)
