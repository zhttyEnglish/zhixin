    ...
    VB_CAL_CONFIG_S *pstCalConfig)
{
    ...
    SC_U32 u32MainStride = 0, u32UvStride = 0;
    ...
    if (enCmpMode == COMPRESS_MODE_NONE)
    {
        ...
        u32UvStride = ALIGN_UP((u32Width / 2 * u32BitWidth + 7) >> 3, u32Align);
        ...
        {
            u32MainSize = u32MainStride * u32AlignHeight + u32UvStride * u32AlignHeight;
        }
