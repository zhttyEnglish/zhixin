#ifndef __SC_MIPI_TX__
#define __SC_MIPI_TX__
...
#define SC_MIPI_TX_IOC_MAGIC   't'

#define SC_MIPI_TX_SET_DEV_CFG              _IOW(SC_MIPI_TX_IOC_MAGIC, 0x01, combo_dev_cfg_t)
#define SC_MIPI_TX_SET_CMD                  _IOW(SC_MIPI_TX_IOC_MAGIC, 0x02, cmd_info_t)
#define SC_MIPI_TX_ENABLE                   _IO(SC_MIPI_TX_IOC_MAGIC, 0x03)
#define SC_MIPI_TX_GET_CMD                  _IOWR(SC_MIPI_TX_IOC_MAGIC, 0x04, get_cmd_info_t)
#define SC_MIPI_TX_DISABLE                  _IO(SC_MIPI_TX_IOC_MAGIC, 0x05)
